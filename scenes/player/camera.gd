...
@export var IDLE_BOB_SPEED: float = 1.8       # Скорость ленивого дыхания (чуть быстрее)
@export var IDLE_BOB_AMOUNT: float = 0.015    # Амплитуда дыхания (около 1.5 см — теперь покачивание в простое чётко видно глазами)
...
@export var WALK_BOB_AMOUNT: float = 0.08     # Амплитуда вверх-вниз (голова качается на ~8 см, создавая честное ощущение массы тела)
@export var WALK_BOB_SIDE: float = 0.05       # Амплитуда влево-вправо (мягкий стрейф при переносе веса с ноги на ногу)
